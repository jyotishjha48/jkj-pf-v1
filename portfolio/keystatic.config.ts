  ...
  singletons: {
    ...
    siteSettings: singleton({
      ...
      schema: {
        ...
        skillsIntro: fields.text({ label: "Skills Page Subheading", multiline: true, defaultValue: "All skills mapped to real project and experience evidence." }),
        ...
        missionsIntro: fields.text({ label: "Missions Page Subheading", multiline: true, defaultValue: "All projects and workshops." }),
        blogHeader: fields.text({ label: "Blog Page Header", defaultValue: "Blog" }),
        blogIntro: fields.text({ label: "Blog Page Subheading", multiline: true, defaultValue: "Writing on robotics, AI, engineering, and learning." }),
        experienceIntro: fields.text({ label: "Experience Page Intro", multiline: true }),
        awardsHeader: fields.text({ label: "Awards Page Header", defaultValue: "Awards" }),
        awardsIntro: fields.text({ label: "Awards Page Subheading", multiline: true, defaultValue: "Recognition, grants, and academic distinctions." }),
        professionalHeader: fields.text({ label: "Professional Experience Header", defaultValue: "Professional Experience" }),
        professionalIntro: fields.text({ label: "Professional Experience Subheading", multiline: true }),
        researchHeader: fields.text({ label: "Research Experience Header", defaultValue: "Research Experience" }),
        researchIntro: fields.text({ label: "Research Experience Subheading", multiline: true }),
        leadershipHeader: fields.text({ label: "Leadership Page Header", defaultValue: "Leadership & Volunteer Experience" }),
        leadershipIntro: fields.text({ label: "Leadership Page Subheading", multiline: true, defaultValue: "Community leadership, robotics education, and volunteer service." }),
        certificationsHeader: fields.text({ label: "Certifications Page Header", defaultValue: "Certifications" }),
        certificationsIntro: fields.text({ label: "Certifications Page Subheading", multiline: true }),
